...
const generateQuizFromText = async (text) => {
  try {
    ...
    return {
      questions: [
        { question: 'What is Artificial Intelligence?', options: ['Machine Learning', 'Human Intelligence', 'Computer Vision', 'Data Science'], correctAnswer: 'Machine Learning', explanation: 'AI is the simulation of human intelligence in machines.' },
        { question: 'Which technology powers AI chatbots?', options: ['Blockchain', 'NLP', 'VR', 'IoT'], correctAnswer: 'NLP', explanation: 'Natural Language Processing enables chatbots.' },
        { question: 'What does ML stand for?', options: ['Machine Learning', 'Markup Language', 'Multiple Layers', 'Memory Logic'], correctAnswer: 'Machine Learning', explanation: 'ML is Machine Learning, a subset of AI.' }
      ]
    };
  }
};
